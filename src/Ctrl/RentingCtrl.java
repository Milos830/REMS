...
public class RentingCtrl implements Observer{
	...
	private FrmRenting view;
	private Model model;
	private Property nekretnina;
	private Renting iznajmljivanje;
	private RentalItems stavke;

	public RentingCtrl(FrmRenting view, Model model, String status) {
		this.view=view;
		this.model=model;
	...
	public class KlikListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			ArrayList<RentalItems> stavke = model.getAllStavkeIznajmljivanjaForID(view.getSelectedItemFromTable().getIDnekretnina());
			Object[][] podaci3 = new Object[stavke.size()][zaglavlje3.length];
			int i = 0;
			for(RentalItems red : stavke)
			{
	...
	public void update(Observable arg0, Object arg1) {
		...
		if(((ArrayList<Object>) arg1).get(0) instanceof Property)
		{
			...
			ArrayList<Property> lista2 = new ArrayList<Property>();
		...
		else if (((ArrayList<Object>)arg1).get(0) instanceof RentalItems)
		{
			ArrayList<RentalItems> lista = (ArrayList<RentalItems>)arg1;
			Object[][] podaci2 = new Object[lista.size()][zaglavlje2.length];
			int i=0;
			for (RentalItems red : lista) {
		...
		else if (((ArrayList<Object>)arg1).get(0) instanceof Custommer)
		{
			ArrayList<Custommer> kup = (ArrayList<Custommer>) arg1;
			view.setKupacCB(kup);
		}
		else  if (((ArrayList<Object>)arg1).get(0) instanceof Employed)
		{
			ArrayList<Employed> zap = (ArrayList<Employed>) arg1;
	...
	public class DjordjeListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			{
				iznajmljivanje = new Renting(0, view.getBrojIznajmljivanja(),
						(Custommer) view.getKupac(), (Employed) view.getZaposleni());
				model.SacuvajIznajmljivanje(iznajmljivanje);
				view.EnableStavke();
			}
			else if (action.equals("Iznajmi"))
			{
				RentalItems stavke = new RentalItems(0, iznajmljivanje, (Property) view.getNekretnina(), view.getDatePocetak(), view.getDateKraj(), view.getCena());
				model.SacuvajStavkeIz(stavke);
				model.IzmeniSTATUSnekretnineIZNAJMLJIVANJE((Property) view.getNekretnina());
				model.getAllRealEstate("");
				model.getAllRents();
				model.getStavkeIznajmljivanja();
				view.ClearFields();
			...
			{
			view.EnableStavke();
			RentalItems st = view.getSelectedItemFromTable1();
