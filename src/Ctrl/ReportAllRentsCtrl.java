...
public class ReportAllRentsCtrl implements Observer{
	...
	public void update(Observable arg0, Object arg1) {
		...
		if(((ArrayList<Object>)arg1).get(0) instanceof RentalItems)
		{
			stavke = (ArrayList<RentalItems>)arg1;
	...
	public void pdfAllRents() {
		...
		try {
			...
			for(RentalItems si : stavke) //SADRZAJ 2 TABELE
			{ 
