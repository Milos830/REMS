...
import Ctrl.SityCtrl;
import Ctrl.HeatingCtrl;
import Ctrl.LocationCtrl;
import Ctrl.FurnitureCtrl;
import Ctrl.PropertyCtrl;
import Ctrl.TypeOfConstructionCtrl;
import Ctrl.TypeOfProperyCtrl;
import Data.City;
import Data.Heating;
...
public class FrmProperty extends JFrame {
	...
	public FrmProperty(String arg0)  {
		super(arg0);
		setTitle("Nekretnina");
	...
	public Property getSelectedItemFromTable() {
		if(tblNekretnina.getSelectedRow()>=0)
		{
		return (Property) tblNekretnina.getValueAt(tblNekretnina.getSelectedRow(),1);
		}
		return null;
} 
	...
	{
	((TypeOfProperty) tblNekretnina.getValueAt(tblNekretnina.getSelectedRow(), 1)).getIDtip_nekretnine();
		for (int i =0;i<cbTipNekretnine.getItemCount();i++) {
			if((((TypeOfProperty)cbTipNekretnine.getItemAt(i)).getIDtip_nekretnine())==((TypeOfProperty) tblNekretnina.getValueAt(tblNekretnina.getSelectedRow(), 1)).getIDtip_nekretnine()) 
			{
