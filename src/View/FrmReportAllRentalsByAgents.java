...
public class FrmReportAllRentalsByAgents extends JFrame {
	...
	public FrmReportAllRentalsByAgents(String title)  {
		super(title);
		initialize();
	}
	...
	public Employed getSelectedItemFromTable()
	{
		if(tblZaposleni.getSelectedRow()>=0)
		{
			return ((Employed) tblZaposleni.getValueAt(tblZaposleni.getSelectedRow(), 2));
		}
		return null;
	}
