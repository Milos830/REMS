...
public class FrmSale extends JFrame {
...
/////////////////////// Kombo boksevi
	...
	public void setNekretninaCB (ArrayList<Property> nek)
	{
...
//	}
	...
	public void setkupacCB(int ID)
	{
		...
		{
			if(((Custommer)cbKupac.getItemAt(i)).getIDkupac()==ID)
			{
