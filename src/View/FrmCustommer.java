...
public class FrmCustommer extends JFrame {
	...
	public FrmCustommer(String title)  {
		super(title);
		initialize();
	}
	...
	public Custommer getSelectedItemFromTable() {
		if(tblKupac.getSelectedRow()>=0)
		{
		return (Custommer) tblKupac.getValueAt(tblKupac.getSelectedRow(),1);
		}
		return null;
} 
	
	public Custommer getSelectedKupac() {
		return (Custommer) tblKupac.getValueAt(tblKupac.getSelectedRow(), 1);
	}
