...
public class FrmRenting extends JFrame {
	...
	public void setNekretninaCB(ArrayList<Property> n)
	{
		for (Property nekretnina : n) {
	...
	public void setnekretninaCB(int ID)
	{
		...
		{
			if(((Property)cbNekretnina.getItemAt(i)).getIDnekretnina()==ID)
			{
	...
	public void setKupacCB (ArrayList<Custommer> kupci)
	{
		for (Custommer k : kupci) {
			cbKupci.addItem(k);
			
		}
	}
	
	public void setZaposleniCB (ArrayList<Employed> zap)
	{
		for (Employed z : zap) {
	...
	public void setkupacCB(int ID)
	{
		...
		{
			if(((Custommer)cbKupci.getItemAt(i)).getIDkupac()==ID)
			{
	...
	public void setzaposleniCB(int ID)
	{
		...
		{
			if(((Employed)cbZaposleni.getItemAt(i)).getIDzaposleni()==ID)
			{
...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public RentalItems getSelectedItemFromTable1()
	{
		if(tblIznajmljenihNekretnina.getSelectedRow()>=0)
		{
			return (RentalItems) tblIznajmljenihNekretnina.getValueAt(tblIznajmljenihNekretnina.getSelectedRow(), 2);
		}
		return null;
	}
